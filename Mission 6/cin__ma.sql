...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 18 Octobre 2024 à 17:02
...
(3, 'BORHINGER', 'RICHARD', '1942-06-06', 132),
...
CREATE TABLE IF NOT EXISTS `distributeurs` (
  `Distributeurs` varchar(60) NOT NULL,
  `IDENT_FILM` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `distributeurs` (`Distributeurs`, `IDENT_FILM`) VALUES
('GAUMONT', 1),
('GAUMONT', 2),
('20th Century Fox', 3),
('20th Century Fox', 4);
...
INSERT INTO `film` (`IDENT_FILM`, `TITRE`, `GENRE1`, `GENRE2`, `DATE_SORTIE`, `PAYS`, `IDENT_REALISATEUR`, `DUREE`) VALUES
(1, 'SUBWAY', 'POLICIER', 'DRAME', '1985-04-10', 1, 1, 104),
(2, 'NIKITA', 'DRAME', 'ROMANTIQUE', '1990-02-21', 1, 1, 118),
(3, 'STAR WARZ 6 : LE RETOUR DU JEDI', 'ACTION', 'SF', '1983-10-19', 2, 2, 133),
